...
data class AttendanceDto(
    ...
    @SerializedName("conducted_by_avatar") val conductedByAvatar: String? = null,
    @SerializedName("conducted_by_photo") val conductedByPhoto: String? = null,
    @SerializedName("conducted_by_role") val conductedByRole: String? = null,
...
data class AssignmentDto(
    ...
    @SerializedName("maximum_marks") val maximumMarks: String? = null,
    @SerializedName("pass_percentage") val passPercentage: String? = null,
    @SerializedName("submission_method") val submissionMethod: String? = null,
    @SerializedName("allowed_url_types") val allowedUrlTypes: List<String>? = null,
    @SerializedName("url_required") val urlRequired: Boolean = true,
    @SerializedName("commit_hash_required") val commitHashRequired: Boolean = false,
    @SerializedName("maximum_attempts") val maximumAttempts: Int = 3,
    @SerializedName("late_submission_allowed") val lateSubmissionAllowed: Boolean = false,
    @SerializedName("reference_url") val referenceUrl: String? = null,
    val status: String? = null,
...
data class AssignmentSubmissionRequest(
    ...
    @SerializedName("assignment_id") val assignmentId: String? = null,
    @SerializedName("submission_text") val submissionText: String? = null,
    @SerializedName("student_comment") val studentComment: String? = null,
...
data class SubmissionDto(
    ...
    @SerializedName("commit_hash") val commitHash: String? = null,
    @SerializedName("submission_method") val submissionMethod: String? = null,
    @SerializedName("attempt_number") val attemptNumber: Int = 1,
    @SerializedName("submission_status") val submissionStatus: String? = null,
    @SerializedName("resubmission_reason") val resubmissionReason: String? = null,
    @SerializedName("github_repo_url") val githubRepoUrl: String? = null,
