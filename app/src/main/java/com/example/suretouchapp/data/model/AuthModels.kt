...
data class UserResponse(
    ...
    @SerializedName("user_permissions") val userPermissions: List<String>? = emptyList(),
    @SerializedName("prevent_unsuspend") val preventUnsuspend: Boolean? = null,
    @SerializedName("prevent_student_unsuspend") val preventStudentUnsuspend: Boolean? = null,
    @SerializedName("can_unsuspend") val canUnsuspendPerm: Boolean? = null,
